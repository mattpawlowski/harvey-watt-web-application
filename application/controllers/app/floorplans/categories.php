...
class Categories extends CI_Controller {
	...
	public $data = array();
    public $path = '/admin/floorplans/categories';
    public $primary_table = 'fdcms_floorplans_categories';
	...
	public function edit() {
        ...
        $this->data["scripts"] = '';
        $this->data["styles"] = '';
        $this->data["adminTitle"] = 'Edit Floorplan Category &raquo; <span class="small">'.$model->getCategoryname($id).'</span>';
    ...
    public function delete() {
        ...
        $SQL = "DELETE FROM fdcms_floorplans_categories WHERE category_id = '".$id."' LIMIT 1";
        $query = $this->db->query($SQL);
        
        $SQL2 = "DELETE FROM fdcms_locations_f2c WHERE category_id = '".$id."'";
