...
$(document).ready(function() {
   ...
   $('.upload-new').click(function() {
        ...
        var html = '<form action="/admin/gallery/all/imagesupdate/'+galleryId+'" method="post" enctype="multipart/form-data">';
            html += '<input type="hidden" name="gallery_id" id="gallery_id" value="'+galleryId+'">';
   ...
   $('.image-edit').click(function() {
        ...
        var html = '<form action="/admin/gallery/all/imagesdetails/'+galleryId+'" method="post" enctype="multipart/form-data">';
            html += '<input type="hidden" name="gallery_id" id="gallery_id" value="'+galleryId+'">';
            html += '<input type="hidden" name="image_id" id="image_id" value="'+imageId+'">';
