...
function convertData() {
    ...
    // Build our awesome and Insert them
        var url = "/admin/floorplans/all/saveassignments/"+locationId;
        ...
        setTimeout(function() { window.location.href = "/admin/floorplans/all/refreshassignemnts/"+locationId; }, (assignments.length * 500));
}